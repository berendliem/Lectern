...
export default async function SearchPage({
  ...
  return (
    <div className="flex flex-col gap-4">
      <div>
        <h1 className="text-xl font-semibold tracking-tight text-zinc-900">Search</h1>
        <p className="mt-0.5 text-[13px] text-zinc-400">Find anything across transcripts, notes, and flashcards.</p>
      </div>
