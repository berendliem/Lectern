  ...
  return (
    ...
    >
      ...
      {dueCount > 0 && (
        <Link
          href="/review"
          className="inline-flex items-center justify-center rounded-lg bg-brand px-4 py-2 text-[13px] font-semibold text-white shadow-brand hover:opacity-95 w-full sm:w-auto"
        >
          Review {dueCount}
        </Link>
      )}
